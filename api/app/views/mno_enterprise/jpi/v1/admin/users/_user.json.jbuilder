json.extract! user, :id, :uid, :email, :phone_country_code, :phone, :name, :surname, :admin_role, :created_at,
  :updated_at, :confirmed_at, :last_sign_in_at, :sign_in_count, :locked_at, :geo_country_code, :failed_attempts,
